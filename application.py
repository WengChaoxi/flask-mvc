...
class App(Flask):
    def __init__(self, import_name, static_folder, template_folder, root_path):
        super(App, self).__init__(import_name, static_folder=static_folder, template_folder=template_folder, root_path=root_path)
...
app = App(__name__, static_folder=static_path, template_folder=templates_path, root_path=os.getcwd())
